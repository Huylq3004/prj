<%-- 
    Document   : typelist
    Created on : Mar 11, 2023, 10:37:28 PM
    Author     : huylq
--%>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="home">All Products</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="listtype?cid=${0}">${c.cateName}</a></li>
                                
                                    <c:forEach items="${categoryList}" var="c">
                                    <li><hr class="dropdown-divider" /></li>
                                    <li><a class="dropdown-item" href="listtype?cid=${c.cateID}">${c.cateName}</a></li>
                                    </c:forEach>
                            </ul>
                        </li>
    ...
    <nav aria-label="...">
        <ul class="pagination">
            <li class="page-item ${page == 1 ? 'disabled':''}">
                <a class="page-link" href="listtype?page=${page-1}">Previous</a>
            </li>
                ...
                <c:otherwise>
                    <li class="page-item"><a class="page-link" href="listtype?page=${p}">${p}</a></li>    
                </c:otherwise>
                    </c:choose>
                                </c:forEach>
                            <li class="page-item ${page == totalPage ? 'disabled':''}">
                                <a class="page-link" href="listtype?page=${page+1}">Next</a>
                            </li>
                        </ul>
                    </nav>
